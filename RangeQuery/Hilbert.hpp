...
// 2 dimensions
void sub_range_decompose(unsigned max_bits, unsigned current_bits, int down_x, int up_x, int down_y, int up_y, int center_x, int center_y, direction pre, direction dir, quadrant quad_, vector<interval> &intervals) { // here we should use stack instead
...
vector<interval> mergeContinousIntervals(vector<interval> &intervals) {
...
int getTotalIntervalsCount(unsigned max_bits, unsigned lower_x, unsigned upper_x, unsigned lower_y, unsigned upper_y) {
